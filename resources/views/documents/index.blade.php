                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach($folders as $folder)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                            {!! format_date_superscript($folder->updated_at, 'date') !!}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-center space-x-2 row-actions">
                                                ...
                                                @endcan
                                                @can('delete', $folder)
                                                    <x-action-icon type="delete" wire:click="confirmDelete({{ $folder->id }})" title="Delete folder" />
                                                @endcan
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="flex items-center justify-center space-x-2 row-actions">
                                                ...
                                                @can('view', $document)
                                                    @if ($document->upload_status === 'completed' && $document->isPreviewableInBrowser())
                                                        <x-action-icon type="view" wire:click="openPreview({{ $document->id }})" wire:loading.attr="disabled" title="Preview document" />
                                                    @endif
                                                @endcan
